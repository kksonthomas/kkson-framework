...
use KKsonFramework\CRUD\Exception\NoBeanException;
use KKsonFramework\CRUD\Exception\NoFieldException;
use KKsonFramework\CRUD\Exception\TableNameException;
use KKsonFramework\CRUD\FieldType\CheckboxManyToMany;
use KKsonFramework\CRUD\FieldType\DropdownManyToOne;
...
class KKsonCRUD
{
     ...
     * @var callable
     */
    protected $isAllowEditClause = null;
     ...
     */
    public function __construct($viewDir = "view")
    {
        try {
        ...
        // Keep old name
        $this->addTheme("AdminLTE", __DIR__ . "/../../../view/theme/AdminLTE");
    ...
    public function getIsAllowEditClause(): ?callable
    {
        return $this->isAllowEditClause;
    }

    public function setIsAllowEditClause(callable $isAllowEditClause): void
    {
        $this->isAllowEditClause = $isAllowEditClause;
    }

    public function getIsAllowDeleteClause(): ?callable
    {
        return $this->isAllowDeleteClause;
    }

    public function setIsAllowDeleteClause(callable $isAllowDeleteClause): void
    {
        $this->isAllowDeleteClause = $isAllowDeleteClause;
    }
     ...
     */
    public function setExportName(string $exportName): void
    {
...
HTML;
    ...
    protected function beforeGetListViewData($callbackRedBean, $callbackSQL, $start = null, $rowPerPage = null, $keyword = null, $sortField = null, $sortOrder = null)
    {
        try {
            ...
            if ($this->sql != null) {
                ...
                // Sorting
                if ($sortField != null) {
                    $fakeSelect = "SELECT * FROM kksonframework_crud_fake_table WHERE ";
    ...
    {
        return isset($this->fieldList[$name]) ? $this->fieldList[$name] : null;
    }
