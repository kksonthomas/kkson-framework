...
class CKEditor extends FieldType
{
    ...
    public function render($echo = false)
    {
        ...
        <div class="form-group">
            ...
            <textarea id="field-$name" class="editor form-control d-none" name="$name" $readOnly $required>$value</textarea>
        </div>
HTML;
        ...
        $(document).ready(function () {
            ...
            let editor;
            CKEDITOR.ClassicEditor.create(field[0], {
                ...
                editor.model.document.on( 'change:data', () => {
                    field.html( editor.getData() );
                });
            }).catch( error => {
                console.error(error);
                AlertUtils.showError( "Error on CKEditor initialization", error );
            });
        });
JS
);
